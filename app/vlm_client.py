...
_RX_PROMPT = (
    ...
    "Retail, Mail-Order, and Specialty Drugs in the SAME tier cell, e.g. "
    "'Tier 2: Retail $40 / Mail-Order $80 / Specialty Drugs $40'. "
    "You MUST extract the Specialty Drugs cost from EVERY tier row (1 through 4). "
    "Preferred format: append a Specialty Drugs aggregate row after Tier 4: "
    "'Tier 1: $10 / Tier 2: $40 / Tier 3: $75 / Tier 4: $125 / Specialty Drugs: $10 / $40 / $100 / $150'. "
    "Alternate format: parenthetical per tier: "
    "'Tier 1: $10 (Specialty Drugs: $10) / Tier 2: $40 (Specialty Drugs: $40) / "
    "Tier 3: $75 (Specialty Drugs: $100) / Tier 4: $125 (Specialty Drugs: $150)'. "
    "Also extract Mail-Order costs per tier into In-Network Mail Order RX "
    "(e.g. '$20 / $80 / $150 / $250'). Do NOT omit Specialty Drugs just because "
    "they appear inside the tier cell rather than as a separate row.\n"
    "BCBS RETAIL / MAIL SERVICE SUPPLY: Some plans (e.g. Blue Cross Blue Shield of Massachusetts) "
