...
_RX_PROMPT = (
    ...
    "FLAT OON PHARMACY COLUMN: When the Out-of-Network pharmacy column shows the SAME cost on "
    "each drug row (e.g. '50% coinsurance (retail), deductible does not apply' repeated for "
    "Preferred generic, Preferred brand, and Non-preferred rows), still write Out-of-Network RX "
    "with one label per row — never collapse to a single unlabeled value. Example: "
    "'Generic: 50% coinsurance, deductible does not apply / Brand: 50% coinsurance, "
    "deductible does not apply / Tier 3: 50% coinsurance, deductible does not apply / "
    "Specialty drugs: Not covered'. Include specialty separately when that row says "
    "'Not covered'.\n"
    ...
    "SPECIALTY DRUGS ROW: Some SBC tables list a separate 'Specialty drugs' row below Tier 4 "
    "with sub-rows (Generic / Preferred / Non-Preferred). Label it exactly 'Specialty Drugs:' "
    "and include all sub-row costs in In-Network RX and Out-of-Network RX. "
    "Example: 'Tier 1: $30 / Tier 2: $65 / Tier 3: $100 / Tier 4: $240 / "
    "Specialty Drugs: Generic: $190 / Preferred: $275 / Non-Preferred: $325'.\n"
    "SPECIALTY DRUGS INSIDE EACH TIER CELL: UnitedHealthcare-style SBC rows often list "
    "Retail, Mail-Order, and Specialty Drugs in the SAME tier cell. Extract ALL THREE "
    "channels for EVERY tier (1 through 4). Common formats:\n"
    "  'Tier 1: Retail $10 / Mail-Order $20 / Specialty Drugs $10'\n"
    ...
    "TIER CELL BOILERPLATE (UHC): Phrases like 'Deductible does not apply' at the start of a "
    "tier cell describe WHEN the deductible applies — they are NOT the tier cost. Always "
    "extract the Retail, Mail-Order, and Specialty Drugs dollar amounts from the same cell. "
    "Example: 'Deductible does not apply. Retail: $10 copay Mail-Order: $20 copay "
    "Specialty Drugs: $10 copay' -> 'Tier 1 (Generic): Retail $10 copay / Mail-Order $20 copay / "
    "Specialty Drugs $10 copay'. NEVER output 'Tier 1 (Generic): Deductible does not apply' "
    "without the Retail/Mail/Specialty costs.\n"
    "Also accepted: comma-separated without Retail label: "
    "'Tier 1: $25 copay, Mail-Order: $50 copay, Specialty Drugs: $25'. "
    "Put the FULL labeled cell text into In-Network RX — do NOT collapse to retail-only. "
    "Preferred aggregate after Tier 4: "
    "'Tier 1: $10 / Tier 2: $40 / Tier 3: $75 / Tier 4: $125 / Specialty Drugs: $10 / $40 / $100 / $150'. "
    "Alternate parenthetical per tier: "
    "'Tier 1: $10 (Specialty Drugs: $10) / Tier 2: $40 (Specialty Drugs: $40) / "
    "Tier 3: $75 (Specialty Drugs: $100) / Tier 4: $125 (Specialty Drugs: $150)'. "
    "Do NOT put Specialty Drugs costs into Mail Order RX — Mail Order must use only "
    "the Mail-Order line from each tier. Do NOT omit Specialty Drugs just because "
    "they appear inside the tier cell rather than as a separate row.\n"
    "FORMAT-SPECIFIC RULES — apply ONLY the block that matches the document layout. "
    "UnitedHealthcare Tier 1-4 with Retail/Mail-Order/Specialty Drugs per cell is NOT a BCBS "
    "6-row table; do not collapse UHC tiers to Generic/Brand/Specialty.\n\n"
    "BCBS 6-ROW PREFERRED/NON-PREFERRED TABLE (apply ONLY when the document lists six rows "
    "named Generic (Preferred), Generic (Non-Preferred), Brand (Preferred), Brand "
    "(Non-Preferred), Specialty (Preferred), Specialty (Non-Preferred)): Some SBCs (e.g. "
    "Blue Cross Blue Shield of Oklahoma) list six pharmacy rows inside the Network Provider "
    "column. Each row shows TWO retail costs in the cell: 'Retail: Preferred - {amount} "
    "Participating - {amount}'. You MUST include BOTH retail amounts for every row — never "
    "output only the Preferred - value. Format each row using the document's "
    "Preferred/Participating labels, e.g. 'Generic (Preferred): Preferred - No Charge "
    "Participating - $10/prescription / Generic (Non-Preferred): Preferred - $10/prescription "
    "Participating - $20/prescription / Brand (Preferred): Preferred - $50/prescription "
    "Participating - $70/prescription / Brand (Non-Preferred): Preferred - $100/prescription "
    "Participating - $120/prescription / Specialty (Preferred): $250/prescription / "
    "Specialty (Non-Preferred): $350/prescription'. Put all six rows in In-Network RX AND "
    "Out-of-Network RX (do not omit Specialty rows from Out-of-Network RX). Out-of-Network "
    "RX must use the SAME six row labels as In-Network — NEVER collapse to plain "
    "'Generic / Brand / Specialty' because that drops Brand (Non-Preferred) and Specialty "
    "(Non-Preferred). Example Out-of-Network RX: 'Generic (Preferred): $10/prescription / "
    "Generic (Non-Preferred): $20/prescription / Brand (Preferred): $70/prescription / "
    "Brand (Non-Preferred): $120/prescription / Specialty (Preferred): $250/prescription / "
    "Specialty (Non-Preferred): $350/prescription'. Leave Preferred Network RX empty for "
    "this layout — both retail columns belong in In-Network RX, not a separate Preferred "
    "Network column. Extract mail-order costs from the Mail: lines into In-Network Mail "
    "Order RX ONLY (e.g. 'No Charge / $30 / $150 / $300') — never copy retail $ amounts "
    "into Mail Order RX.\n"
    "BCBS RETAIL / MAIL SERVICE SUPPLY (apply ONLY when cells use '/ retail supply' and "
    "'/ mail service supply' phrases): Some plans (e.g. Blue Cross Blue Shield of "
    "show costs as '$10 / retail supply or $20 / mail service supply' within each drug row. "
    "Extract the FULL cell text for each row label (Generic drugs, Preferred brand drugs, etc.) "
    "including all '/ retail supply' and '/ mail service supply' phrases. "
    "Use one labeled row per drug category; separate categories with ' / ' only between labels, "
    "not inside a cell. Example:\n"
    "  In-Network RX = 'Low-Cost Generic: $10 / retail supply or $20 / mail service supply for "
    "low-cost generic drugs; $45 / retail supply or $90 / mail service supply for other generic "
    "drugs / Preferred Brand: $150 / retail supply or $300 / mail service supply / "
    "Non-Preferred Brand: $225 / retail supply or $675 / mail service supply / "
    "Specialty Drugs: $10 / retail supply for low-cost generic drugs; $45 / retail supply for "
    "other generic drugs; 50% coinsurance / retail supply for preferred brand specialty drugs; "
    "50% coinsurance / retail supply for non-preferred specialty drugs'\n\n"
    "MAIL ORDER ROW COVERAGE: Apply the same non-collapsing rule to mail-order extraction. "
    "When the document shows separate preferred/plain/non-preferred rows for mail-order (or home delivery), "
    "include ALL corresponding costs in Mail Order RX in the same row order as retail. "
    "Do not keep only the first one or two values; capture all printed mail-order rows for that network. "
    "If only some tiers have mail-order prices, include exactly those tiers (in order) and omit missing tiers.\n\n"
    ...
    "or percentage cost expressions explicitly PRINTED in the document as mail-order prices. "
    "Limitation notes like "
    ...
    "verify that the exact cost expression (dollar amount OR percentage coinsurance) appears "
    "verbatim in the document as a printed mail-order price. If any value does not appear "
    "verbatim (e.g. you doubled a retail "
