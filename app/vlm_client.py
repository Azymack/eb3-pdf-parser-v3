...
_RX_PROMPT = (
    ...
    "SBC PHARMACY TABLE (Summary of Benefits): Many SBC documents list prescription drugs in a "
    "3-column table — 'Services You May Need' | 'What You Will Pay - In-Network Provider' | "
    "'What You Will Pay - Out-of-Network Provider'. Extract EACH ROW separately:\n"
    "  - Use the tier label from the Services column exactly as printed.\n"
    "  - Put the In-Network column cell into In-Network RX (or Designated Network RX).\n"
    "  - Put the Out-of-Network column cell into Out-of-Network RX with the SAME tier label.\n"
    "  - NEVER collapse all Out-of-Network rows into one undifferentiated value when the table "
    "shows a distinct Out-of-Network cost on every tier row.\n"
    "  - When a cell combines retail and home delivery in one cell "
    "(e.g. '$15/prescription (retail) and $30/prescription (home delivery)'), include the "
    "full cell text in the retail RX field for that tier.\n"
    "MERGED TIER ROWS: Some SBC plans combine drug types in one row label, e.g. "
    "'Typically Preferred Brand & Non-Preferred Generic Drugs (Tier 2)' or "
    "'Typically Non-Preferred Brand and Generic drugs (Tier 3)'. Keep the document's exact "
    "combined row label — do NOT split into separate Generic and Brand rows.\n"
    "DUAL PHARMACY TABLES: Some plans show TWO separate prescription tables:\n"
    "  1) Prescription Drug Product Tier Level (main retail tiers 1-4)\n"
    "  2) Specialty Prescription Drug Product Tier Level (specialty tiers 1-4)\n"
    "Put the main retail table into In-Network RX / Out-of-Network RX. "
    "Put the specialty table into Preferred Network RX using labels that include "
    "'Specialty Prescription Drug Product Tier Level' or 'Specialty Tier N'. "
    "Do NOT merge specialty table costs into the main Tier 1-4 retail fields.\n"
    "Example — main retail + specialty table:\n"
    "  In-Network RX = 'Typically Generic (Tier 1): $15/prescription (retail) and "
    "$30/prescription (home delivery) / Typically Preferred Brand & Non-Preferred Generic "
    "Drugs (Tier 2): $45/prescription (retail) and $113/prescription (home delivery) / "
    "Typically Non-Preferred Brand and Generic drugs (Tier 3): 25% coinsurance up to "
    "$200/prescription (retail) and 25% coinsurance up to $500/prescription (home delivery) / "
    "Typically Preferred Specialty (brand and generic) (Tier 4): 25% coinsurance up to "
    "$400/prescription (retail and home delivery)'\n"
    "  Out-of-Network RX = 'Typically Generic (Tier 1): 50% coinsurance (retail) and "
    "Not covered (home delivery) / Typically Preferred Brand & Non-Preferred Generic Drugs "
    "(Tier 2): 50% coinsurance (retail) and Not covered (home delivery) / "
    "Typically Non-Preferred Brand and Generic drugs (Tier 3): 50% coinsurance (retail) and "
    "Not covered (home delivery) / Typically Preferred Specialty (brand and generic) "
    "(Tier 4): 50% coinsurance (retail) and Not covered (home delivery)'\n\n"
